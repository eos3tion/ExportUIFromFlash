...
interface FlashDocument {
    ...
    /**
     * @available Flash Professional CC.
...
interface FlashText extends FlashElement {
	getTextAttr(attrName: string, startIndex?: number, endIndex?: number);
	getTextString(startIndex?: number, endIndex?: number);
	setTextAttr(attrName: string, attrValue: any, startIndex?: number, endIndex?: number);
	setTextString(text: string, startIndex?: number, endIndex?: number);
	accName: string;
...
interface FlashFLfile {
	...
	runCommandLine(fileURI: string): number;
...
interface FlashBitmapItem {
	exportToFile(fileURI: string,
		JPEGQuality?: number): boolean;
